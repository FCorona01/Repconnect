...
**Phase: Technical discovery. No application code has been written yet.**

This repository currently contains the architecture and implementation plan only.
That is deliberate — the plan is being agreed before any code is committed.
